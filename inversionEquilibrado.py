"""
Análisis Cartera Equilibrada Global - Responsivo
...
fig = plt.figure(figsize=(20, 10), facecolor=BG)                # más ancho
gs = gridspec.GridSpec(1, 2, figure=fig, width_ratios=[1, 1.4],
                        wspace=0.15, left=0.05, right=0.97,
                        top=0.85, bottom=0.12)                  # más espacio arriba/abajo
...
# Título principal con espacio suficiente (sin solapar)
fig.suptitle("Cartera Equilibrada Global · Riesgo/Retorno",
...
plt.savefig("cartera_equilibrada_sharpe.png", dpi=200, bbox_inches="tight", facecolor=BG)
plt.show()
print("✅ Gráfico guardado como cartera_equilibrada_sharpe.png")