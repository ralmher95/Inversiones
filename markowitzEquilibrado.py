"""
Frontera Eficiente Equilibrada - Responsivo
============================================
"""
...
# Anotaciones con fuente más pequeña y sin solape
ax.annotate(
...
ax.set_title("Frontera Eficiente — Cartera Equilibrada",
...
plt.savefig("frontera_equilibrada.png", dpi=200, bbox_inches="tight", facecolor=BG)
plt.show()
...
print("\n✅ frontera_equilibrada.png guardado")