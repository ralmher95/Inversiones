"""
Optimización de Cartera Conservadora - Frontera Eficiente (5 activos, responsive)
=================================================================================
...
# ── CONFIGURACIÓN (5 ACTIVOS CONSERVADORES) ──────────────
ACTIVOS = {
...
N_DIAS = 252
PERIODO = "3y"
MC_SIMULACIONES = 50_000          # Monte Carlo sin scipy
...
print(f"🎲 Simulando {MC_SIMULACIONES:,} carteras aleatorias...")
np.random.seed(42)
...
# Seleccionar las mejores carteras
...
# Anotaciones con más separación (no se solapan)
ax.annotate(
...
plt.savefig("frontera_conservadora_5.png", dpi=200, bbox_inches="tight", facecolor=BG)
plt.show()
...
for i, ticker in enumerate(activos_ok):
    peso = best_w_vol[i] * 100
    if peso > 0.1:
        print(f"  {ACTIVOS.get(ticker, ticker):<22} {peso:5.1f}%")

print("\n✅  Gráfico guardado como frontera_conservadora_5.png")